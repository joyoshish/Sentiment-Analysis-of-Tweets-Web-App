...
st.title ("_Sentiment Analysis_ of Tweets by US airline passengers 🙂🙁😐")
...
#caching loaded data to get rid of excessive computation load every time streamlit runs the app
...
#PLOT NUMBER OF TWEETS CATEGORISED BY SENTIMENT FOR EACH AIRLINE
...
#SHOW WORDCLOUD FOR DIFFERENT CATEGORY TWEETS
